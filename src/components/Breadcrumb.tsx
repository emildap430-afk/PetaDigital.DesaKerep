...
export const Breadcrumb: React.FC<BreadcrumbProps> = ({ items, onNavigate }) => {
  return (
    <nav className="px-4 py-2 bg-slate-100/80 border-b border-slate-200 text-slate-600 text-[11px]">
      <div className="max-w-md mx-auto flex items-center gap-1 overflow-x-auto no-scrollbar whitespace-nowrap">
