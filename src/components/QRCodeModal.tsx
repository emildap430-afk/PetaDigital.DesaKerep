...
export const QRCodeModal: React.FC<QRCodeModalProps> = ({ isOpen, onClose }) => {
  // Default URL to current URL or shared production URL
  const defaultUrl = typeof window !== 'undefined' ? window.location.href : 'https://ais-pre-m26qmjlo7dtoorhxwmv7fw-708929492192.asia-southeast1.run.app';
      ...
      <div className="bg-white w-full max-w-sm rounded-3xl shadow-2xl border border-slate-200 overflow-hidden flex flex-col max-h-[90vh]">
        ...
        <div className="p-4 overflow-y-auto space-y-4 text-center">
          ...
          <div id="printable-qr-section" className="bg-slate-50 p-5 rounded-2xl border border-slate-200 flex flex-col items-center justify-center space-y-3">
            ...
            >
              <QRCodeSVG
                value={url || 'https://ais-pre-m26qmjlo7dtoorhxwmv7fw-708929492192.asia-southeast1.run.app'}
                size={190}
                level="H"
                marginSize={1}
                fgColor="#0b3c2c"
              ...
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <div className="w-[48px] h-[48px] bg-white p-0.5 rounded-lg border border-amber-400/50 shadow-xs flex items-center justify-center overflow-hidden">
                  <CandaBirawaLogo className="w-full h-full object-contain" />
                </div>
              </div>
            </div>
