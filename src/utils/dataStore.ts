...
export interface PotentialData extends BasePotentialData {
  points?: string[];
}
...
const defaultDusunList: DusunItem[] = [
  {
    id: 'dusun-kerep',
    name: 'Dusun Kerep',
    kepalaDusun: 'Bapak Kepala Dusun Kerep',
    jumlahRt: 8,
    jumlahRw: 2,
    luasWilayah: '± 85 Ha',
  ...
  },
  {
    ...
    kepalaDusun: 'Bapak Kepala Dusun Balongasem',
    jumlahRt: 6,
    jumlahRw: 2,
    luasWilayah: '± 70 Ha',
  ...
  {
    id: 'dusun-cabak',
    name: 'Dusun Cabak Banjarsari',
    kepalaDusun: 'Bapak Kepala Dusun Cabak',
    jumlahRt: 5,
    jumlahRw: 2,
    luasWilayah: '± 60 Ha',
...
const defaultPendudukData: PendudukDemografi = {
  ...
  persebaranDusun: [
    ...
    { namaDusun: 'Dusun Cabak Banjarsari (5 RT / 2 RW)', totalPenduduk: 948, totalKk: 290, lakiLaki: 475, perempuan: 473 }
  ]
};
...
export function getStoredProfilData(): ProfilDesaData {
  ...
  try {
    ...
    return { ...defaultProfilDesa, ...JSON.parse(data) };
  } catch {
