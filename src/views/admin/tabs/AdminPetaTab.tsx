          ...
          <div className="bg-white rounded-3xl max-w-md w-full p-5 shadow-2xl border border-slate-200 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-2">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-xs font-black text-slate-900 uppercase">Detail Marker Peta</h3>
              </div>
              <button onClick={() => setViewDetailMarker(null)} className="p-1 text-slate-400 hover:text-slate-600">
                <X className="w-4 h-4" />
              </button>
            </div>
            <div>
              <span className="text-[10px] font-extrabold text-emerald-900 bg-emerald-100 px-2 py-0.5 rounded uppercase">
                {viewDetailMarker.category}
              </span>
              <h4 className="text-sm font-black text-slate-900 mt-1">{viewDetailMarker.name}</h4>
              <p className="text-xs text-slate-600 mt-1">{viewDetailMarker.description || 'Tidak ada keterangan tambahan.'}</p>
            </div>
