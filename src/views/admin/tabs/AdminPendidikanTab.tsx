        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs overflow-y-auto">
          <div className="bg-white rounded-3xl max-w-xl w-full p-6 shadow-2xl border border-slate-200 space-y-4 my-8">
            ...
            <form onSubmit={handleSave} className="space-y-3 text-xs">
              ...
              <div className="space-y-1">
                <label className="font-bold text-slate-700">Foto Sekolah</label>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs">
          <div className="bg-white rounded-3xl max-w-md w-full p-5 shadow-2xl border border-slate-200 space-y-4">
            <div className="flex items-center justify-between border-b border-slate-100 pb-2">
              <h3 className="text-xs font-black text-slate-900 uppercase">Detail Sarana Pendidikan</h3>
            ...
            <div>
              <h4 className="text-sm font-black text-slate-900">{viewDetailItem.name}</h4>
