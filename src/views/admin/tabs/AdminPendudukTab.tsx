        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <h3 className="text-xs font-black text-slate-800 uppercase tracking-wider flex items-center gap-2">
              ...
              <span>3. Struktur & Piramida Kelompok Usia</span>
            </h3>
            <span className="text-[10px] text-slate-400">Balita s/d Lansia</span>
          </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <h3 className="text-xs font-black text-slate-800 uppercase tracking-wider flex items-center gap-2">
              ...
              <span>4. Komposisi Mata Pencaharian / Sektor Pekerjaan</span>
            </h3>
            <span className="text-[10px] text-slate-400">Pertanian, UMKM, Swasta, dll</span>
          </div>
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xs space-y-4">
          <div className="flex items-center justify-between pb-3 border-b border-slate-100">
            <h3 className="text-xs font-black text-slate-800 uppercase tracking-wider flex items-center gap-2">
              ...
              <span>5. Tingkat Pendidikan Terakhir Warga</span>
            </h3>
            <span className="text-[10px] text-slate-400">SD, SMP, SMA, Sarjana</span>
          </div>
