...
export const potensiList: PotentialData[] = [
  {
    ...
    subtitle: "Pertanian",
    image: "/assets/images/pertanian_desa.jpeg",
    ...
    items: [
      ...
      },
      {
        ...
        name: "Pertanian & Hortikultura Dusun Cabak Banjarsari",
        dusun: "Dusun Cabak Banjarsari",
        description: "Persawahan terasering lereng yang subur dengan komoditas padi dan kebun buah pisang/ubi.",
        fullDescription: "Dusun Cabak Banjarsari memiliki bentang persawahan berundak (terasering) alami yang memesona. Selain tanaman padi dengan air pegunungan yang jernih, petani di dusun ini memanfaatkan pematang dan lahan tegalan untuk budidaya pohon pisang raja/ambon, ubi jalar, singkong, dan tanaman keras.",
        komoditas: "Padi Organik Gunung, Pisang Raja/Kepok, Singkong & Ubi Jalar",
        luasLahan: "± 32 Hektar",
        pengelola: "Kelompok Tani 'Sumber Rejeki' Dusun Cabak Banjarsari",
  ...
  },
  {
    ...
    subtitle: "Peternakan",
    image: "/assets/images/Peternakan.jpeg",
    ...
    items: [
      ...
      },
      {
        ...
        name: "Peternakan Mandiri Dusun Cabak Banjarsari",
        dusun: "Dusun Cabak Banjarsari",
        description: "Peternakan sapi peranakan ongole (PO) dan unggas pekarangan rumah tangga.",
        fullDescription: "Warga Dusun Cabak Banjarsari memelihara ternak sapi PO dan unggas bebas lepas di pekarangan luas sebagai bentuk tabungan hidup yang terintegrasi dengan kebun.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        fullDescription: "Dusun Cabak Banjarsari menawarkan bentang alam yang masih sangat alami dengan latar perbukitan hijau. Udara yang sangat segar dan hawa sejuk menjadikannya paru-paru hijau Desa Kerep serta spot favorit warga untuk bersepeda pagi dan jalan santai.",
        komoditas: "Hutan Rakyat, Sumber Mata Air Lereng, Udara Segar Pegunungan",
        pengelola: "LMDH & Karang Taruna Dusun Cabak Banjarsari",
        sumber: "Observasi Lapangan KKN 2026",
        fungsi: [
  ...
  },
  {
    ...
    subtitle: "Masyarakat",
    image: "/assets/images/Masyarakat.jpg",
    ...
    items: [
      ...
      },
      {
        ...
        name: "Paguyuban Rukun Warga Dusun Cabak Banjarsari",
        dusun: "Dusun Cabak Banjarsari",
        description: "Guyub rukun warga lereng, pengajian tahlil/yasinan, dan tradisi sambatan bertani.",
        fullDescription: "Warga Dusun Cabak Banjarsari menjunjung tinggi adat ketimuran dan kebersamaan. Tradisi gotong royong sambatan memperbaiki rumah atau panen raya serta pengajian rutin mingguan menjadi perekat kekeluargaan yang sangat kental.",
  ...
  },
  {
    ...
    description: "Tradisi gotong royong, adat sedekah bumi / bersih desa, serta kesenian jaranan dan karawitan yang terus hidup di tengah masyarakat.",
    fullDescription: "Kekayaan warisan budaya di Desa Kerep senantiasa dirawat dengan penuh kebersamaan. Kegiatan adat tahunan seperti Bersih Desa (Sedekah Bumi), pagelaran kesenian jaranan campursari, pengajian akbar, serta tradisi gotong royong (sambatan) menjadi perekat kerukunan antar warga.",
    lokasi: "Balai Desa Kerep & Pelataran Warga Dusun",
    komoditas: "Sedekah Bumi, Pagelaran Jaranan, Karawitan, Tradisi Gotong Royong",
    sumber: "Observasi KKN 2026 & Tokoh Adat / Masyarakat Desa Kerep",
    pengelola: "Lembaga Adat Desa & Paguyuban Seni Kerep",
    musimPanen: "Peringatan Tahunan (Bulan Suro / Bersih Desa) & Hari Besar",
    fungsi: [
      "Pelestarian Adat Istiadat & Seni Tradisi Luhur Jawa",
      "Mempererat Rasa Guyub Rukun & Gotong Royong Antar Warga",
      "Daya Tarik Kultural Masyarakat Lokal dan Pengunjung",
      "Wadah Ekspresi Kreativitas Generasi Muda Pedesaan"
    ],
    dokumentasi: [
...
export const umkmList: UmkmData[] = [
  {
    ...
    alamat: "Dusun Cabak Banjarsari, Desa Kerep, Kec. Tarokan, Kab. Kediri",
    ...
    fullDeskripsi: "Pabrik UD Rigid box bertempat di Dusun Cabak Banjarsari, Desa Kerep. Merupakan salah satu unit industri manufaktur lokal yang memproduksi aneka kebutuhan kemasan kaku (rigid box custom), kotak kemasan produk UMKM, packaging souvenir, hingga gift box premium dengan pengerjaan rapi dan bahan kokoh.",
    produk: [
    ...
    kontak: "Dusun Cabak Banjarsari, Desa Kerep",
...
export const sekolahList: SchoolData[] = [
  ...
  },
  {
    ...
    name: "Ponpes Al-Irsyadiyyah Banjarsari",
    ...
    deskripsi: "Pondok Pesantren Al-Irsyadiyyah Banjarsari merupakan lembaga pendidikan Islam yang berfokus pada pembelajaran kitab kuning, tahfiz Al-Qur'an, serta pembinaan akhlak mulia bagi para santri di Desa Kerep dan sekitarnya.",
    fasilitas: [
      "Asrama Santri",
      "Masjid / Ruang Ibadah",
...
export const fasilitasCategories: FacilityCategory[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        location: "Dusun Cabak Banjarsari",
        description: "Pos pelayanan terpadu balita, ibu hamil, dan lansia di Dusun Cabak.",
        fullDescription: "Posyandu Nusa Indah 2 melayani masyarakat Dusun Cabak Banjarsari dalam program pemantauan tumbuh kembang anak, penimbangan balita rutin, posbindu lansia, serta edukasi gizi bagi ibu hamil.",
        fungsi: [
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        fullDescription: "Pondok Pesantren Al-Irsyadiyyah Banjarsari memfasilitasi pembinaan keagamaan santri dan masyarakat sekitar melalui program pengajian kitab kuning, tahfiz Al-Qur'an, dan kegiatan keagamaan rutin.",
        fungsi: [
          "Pendidikan Keagamaan Islam & Pembinaan Santri",
          "Kajian Kitab Kuning & Tahfiz Al-Qur'an",
          "Pusat Kegiatan Keagamaan Masyarakat Dusun Banjarsari"
        ],
        jamOperasional: "Setiap Hari (24 Jam / Asrama)",
        pengelola: "Yayasan Ponpes Al-Irsyadiyyah Banjarsari",
        image: "/assets/images/fasilitas-ibadah.jpg",
        dokumentasi: [
          "/assets/images/fasilitas-ibadah.jpg",
          "/assets/images/kegiatan-1.jpg",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Mushola lingkungan RT 02 Dusun Cabak Banjarsari.",
        fullDescription: "Mushola Nurul Huda memfasilitasi peribadatan rutin warga RT 02 Dusun Cabak Banjarsari beserta kegiatan keagamaan tingkat RT.",
        fungsi: [
...
export const mapMarkersList: MapMarkerItem[] = [
  ...
  },
  {
    ...
    lat: -7.7460,
    lng: 111.9220,
    address: "Dusun Cabak Banjarsari, Desa Kerep",
    image: "/assets/images/fasilitas-ibadah.jpg",
    color: "#2563eb" // Blue
  },
  {
